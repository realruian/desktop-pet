Create Codex pet row `running-right` for `pixel-girl`: exactly 8 full-body frames in one horizontal strip on flat pure cyan #00FFFF.

Use the attached canonical base for identity and the layout guide only for spacing. Same pet in every frame: cute pixel-art full-body little girl, long black hair, black beret with small light accent, warm gentle smile, cream striped dress with tied waist, soft curious personality, compact readable desktop pet silhouette. Preserve silhouette, face, palette, material, proportions, markings, and props.
